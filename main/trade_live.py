...
def trade_live(
    ...
    while True:
        ...
        for ticker in [t for t in tickers if t in tickers_pass_2]:
            ...
            return_filter_window_size = kwargs.get('return_filter_window_size')
            info = get_ticker_info(ticker, return_filter_window_size)
            ...
            if all(results):
                ...
                if all(results):
                    ...
                    df_entry = load_ohlcv(ticker, kwargs.get('entry_interval'), "2 hours ago UTC")
